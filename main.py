...
# هذا هو الـ payload الأصلي (ثابت لا يتغير)
...
def proxy_login():
    ...
    # تعديل اليوزر والباس (باستخدام بياناتك)
    ...
    try:
        ...
        if r.status_code == 200:
            ...
            return jsonify({"success": False, "status": r.status_code, "error": "Invalid credentials"})
