...
def proxy_login():
    ...
    # استخدام الـ Protobuf الكامل المسجل
    proto_bytes = base64.b64decode(FULL_PROTOBUF_B64)
    ...
    if response.status_code == 200 and response.headers.get('grpc-status') == '0':
        ...
        print(f"[!] فشل: {response.headers.get('grpc-message')}")
